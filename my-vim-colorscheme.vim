...
hi Comment		  term=bold  cterm=bold ctermfg=black  guifg=#80a0ff
hi Constant		  term=underline  cterm=bold ctermfg=magenta  guifg=#ffa0a0
hi Special		  term=bold  cterm=bold ctermfg=red  guifg=Orange
hi Identifier	  term=underline   ctermfg=green  guifg=#40ffff
hi Statement	  term=bold  cterm=bold ctermfg=cyan gui=bold  guifg=#ffff60
